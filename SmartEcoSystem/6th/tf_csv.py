...
##################################################################################
# 1.  csv 를 판다스 dataframe 형식으로 읽은 후 판다스 데이터 프레임 형식인 dfData로 저장합니다.   #
##################################################################################

###################################################################
# 2.  dfData에서 원하는 열을 추출해 dfDataSel 에 저장합니다.               #
###################################################################

###################################################################
# 3.  원하는 열을 추출한후 100개 데이터를 가져옵니다.(0-99 행 추출)            #
###################################################################

######################################################################
# 4.  미리 정의된  LinearRegression 를 호출하여 학습후 w,b 결과 값을 받아옵니다.  #
######################################################################

##################################################################
# 5. 측정 데이터(dfData)를 앞서배운 plt.scatter 메소드를 이용해서 그립니다.   #
##################################################################
...
############################################
#  6. 110번째 예측 값을 출력해봅니다.             #
############################################

#######################################################
#  7.  110번째의 실제 데이터 값과 예측값의 차이를 계산해 출력합니다. #
#######################################################
